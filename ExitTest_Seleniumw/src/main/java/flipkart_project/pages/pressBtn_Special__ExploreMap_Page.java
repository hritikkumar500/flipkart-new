...
public class pressBtn_Special__ExploreMap_Page {

	WebDriver driver;

	public pressBtn_Special__ExploreMap_Page(WebDriver driver) {
		this.driver = driver;
	}
	...
	@FindBy(how = How.XPATH, using = "/html/body/div[1]/div[1]/div/div/main/article/div/div[1]/section[8]/div/div/div/section/div/div[2]/div/div/div/div/a")
	WebElement viewAll_btn;

	@FindBy(how = How.XPATH, using = "/html/body/div[1]/div[1]/div/div/main/article/div/div[1]/section[1]/div/div/div/section/div/div/div/div[1]/div/h1")
	public static WebElement sellerMapPageHeading_txt;

	public void exploreMapPage() {
